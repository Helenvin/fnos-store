...
const (
	defaultAppsJSONURL = "https://raw.githubusercontent.com/Helenvin/fnos-apps/main/apps.json"
	githubReleaseBase  = "https://github.com/Helenvin/fnos-apps/releases/download"
)
